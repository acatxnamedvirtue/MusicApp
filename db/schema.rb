...
ActiveRecord::Schema.define(version: 20150820204809) do
  ...
  add_index "tracks", ["album_id", "track_number"], name: "index_tracks_on_album_id_and_track_number", unique: true, using: :btree
